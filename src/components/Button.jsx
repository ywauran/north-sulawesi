...
const Button = () => {
  ...
  return (
    <>
      <div
        onClick={() => navigate(-1)}
        className="py-2 pl-4 pr-8 mb-8 rounded buttonBack max-w-max bg-theme1 bg-gradient-to-l from-fuchsia-100 via-purple-200 to-pink-300 hover:cursor-pointer"
      >
        <div className="flex items-center justify-center text-base font-bold text-theme3">
          {" "}
          <svg
            className="w-10"
            clipRule="evenodd"
